...
class Setting(models.Model):
    ...
    # app setting
    app_footprint = models.BooleanField(
        'app_footprint', default=True)       # gui use
    ...
    # ranking
    ranking_display = models.BooleanField(
        'ranking_display', default=True)  # gui use
    ...
    email_message = models.BooleanField(
        'email_message', default=True)       # gui use
...
class Choice(models.Model):
    ...
    subcategory = models.CharField(
        'サブカテゴリ', null=True, blank=True, max_length=50)
    order = models.IntegerField('順序', default=0)
...
class ReceiptSetting(models.Model):
    ...
    # validators=[RegexValidator(r'^\d\d\d-\d\d\d\d$')]
    postal_code = models.CharField('郵便', max_length=8)
