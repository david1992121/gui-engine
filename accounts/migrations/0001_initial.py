# Generated by Django 3.1.3 on 2020-11-03 07:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(blank=True, max_length=192, null=True, unique=True, verbose_name='ニックネーム')),
                ('avatar', django_resized.forms.ResizedImageField(blank=True, crop=['middle', 'center'], force_format='JPEG', keep_meta=True, null=True, quality=75, size=[300, 300], upload_to='static/images/avatar', verbose_name='アバタ')),
                ...
                ('word', models.CharField(blank=True, max_length=192, null=True, verbose_name='今日のひとこと')),
