...
urlpatterns = [
    ...
    path(
        'notices_admin/<int:pk>',
        AdminNoticeView.as_view(),
        name="admin_detail_notices"),
    ...
    path(
        ...
        name="admin_unread_message"),
    path('messages/admin/unread/count',
         get_unread_admin_messages_count,
         name="admin_unread_message_count"),
    path('messages/delete/<int:id>', delete_message, name="delete_message"),
    path(
        'messages/change/<int:id>',
        change_message_state,
        name="change_message_state"),
    ...
    path(
        ...
        name="admin_detail_room"),
    path(
        'admin/rooms/<int:pk>/messages',
        RoomMessageView.as_view(),
        name="admin_room_messages"),
    path('admin/rooms/<int:pk>/users', add_member, name="add_member"),
    path('admin/rooms/<int:pk>/users/<int:id>',
