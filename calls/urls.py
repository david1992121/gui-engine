...
urlpatterns = [
    ...
    path(
        ...
        name="invoice_detail_view"),
    path(
        'users/invoices',
        UserInvoiceView.as_view(),
        name="user_invoice_view"),
    path(
        'detail_invoices',
        DetailInvoiceView.as_view(),
        name="detail_invoice_view"),
    ...
    path('orders/<int:id>/confirm/<int:user_id>',
         confirm_cast, name="cast_confirm"),
    ...
    path(
        'orders/request/<int:pk>/cancel',
        cancel_request,
        name="cancel_request"),
    path(
        'orders/request/<int:pk>/confirm',
        confirm_request,
        name="confirm_request"),
    path(
        'orders/request/<int:pk>/reject',
        reject_request,
        name="reject_request"),
    ...
    path(
        'rooms/<int:id>/joins/check',
        check_cast_status,
        name="check_cast_join"),
